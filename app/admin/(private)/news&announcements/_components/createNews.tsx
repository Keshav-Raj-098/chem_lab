...
const CreateNews = ({ onSuccess }: CreateNewsProps) => {
  ...
  const [type, setType] = useState<NewsAndAnnouncementsType>(NewsAndAnnouncementsType.Event);
  ...
  const handleCreateNews = async () => {
    ...
    try {
      ...
      setTitle("");
      setNewsBody("");
      setType(NewsAndAnnouncementsType.Event);
      setOpen(false);
      onSuccess();
    } catch (error: any) {
        ...
        <DialogContent className="sm:max-w-[700px]">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Select value={type} onValueChange={(value) => setType(value as NewsAndAnnouncementsType)}>
